...
export function ChallengesPanel() {
  ...
  return (
    <div className="w-full sm:w-[90%] md:w-[70%] lg:w-[400px] mx-auto">
      <div className="bg-black/80 backdrop-blur-md border border-white/20 rounded-lg p-4 min-w-[280px] max-h-[70vh] overflow-y-auto">
